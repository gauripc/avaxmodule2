    ...
    try {
      ...
      return (
        <div style={styles.container}>
          ...
          <p style={styles.text}>Total Deposits: {16}</p>
          <p style={styles.text}>Total Withdrawals: {5}</p>
...
const styles = {
  main: {
    textAlign: "center",
    backgroundColor: "lightblue", // Set the background color for the entire page
    padding: "20px",
  ...
  button: {
    backgroundColor: "lightpink", // Set the button background color
    color: "grey",
    padding: "10px",
    margin: "5px",
    cursor: "pointer",
  ...
  text: {
    color: "#555", // Set the text color for other content
  },
};
